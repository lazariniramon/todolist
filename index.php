...
<html>
<head>
	<title>ToDoList Teknisa</title>
	<link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="css/style.css">
	<link rel="icon" href="https://www.teknisa.com/wp-content/uploads/2016/11/cropped-teknisa-favicon-32x32.png" sizes="32x32" />
</head>
<body>
	<div class="container">
		...
		if (isset($_POST['cadastrar'])) {
			...
			if ($nometarefa != '') {
				...
				$Tarefas->setFeito(0);
				if ($Tarefas->insert()) {
					$aviso = '	<br/><div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Cadastrado com sucesso!</div>';
				}
			}
		}
				...
				<div class="container jumbotron">
					...
					<div class="row">
						<div class="input-group col-md-12">
							<input type="text"  class="form-control"  placeholder="Tarefa..." name="nometarefa" required="true">
					...
					<?php foreach($Tarefas->findAll() as $Tarefa){ 
						...
						<tr <?php echo $verde ?>>
							...
							<td  class="col-md-2" >
								...
								echo '<button data-toggle="modal" data-target="#myModal" type="button" class="btn btn-default" data-toggle="tooltip modal" data-placement="top" href="update.php?id='.$Tarefa['id'].'"><span class="glyphicon glyphicon-pencil" aria-hidden="true" ><i class="icon-zoom-in"></i> </span></button>'; ?>
